...
exportBtn.addEventListener('click', () => withLoading(exportBtn, async () => await doExport('csv')))
exportJsonBtn.addEventListener('click', () => withLoading(exportJsonBtn, async () => await doExport('json')))
